...
import { GridItem, Group, HStack, Input, SimpleGrid, Textarea, VStack } from '@chakra-ui/react'
import { FieldError, FieldErrors, UseFormRegister } from 'react-hook-form';

interface CustomerInformationFormStepProps {
    register: UseFormRegister<FormStepData>;
    errors: FieldErrors<FormStepData>;
  }
